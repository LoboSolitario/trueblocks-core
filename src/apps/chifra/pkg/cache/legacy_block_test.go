...
func helperCheckTransaction(t *testing.T, tr *LegacyTransaction, expected *LegacyTransaction) (err error) {
...
func TestReadLegacyBlock(t *testing.T) {
	...
	helperCheckTransaction(t, &block.transactions.items[0], &LegacyTransaction{
		hash:                 cppString{content: []byte("0x5a9d77909e77eee0a768d4160155c60fa77ae5b621e3c6f4fe6c54f509ea8c33")},
		blockHash:            cppString{content: []byte("0x51bc754831f33817e755039d90af3b20ea1e21905529ddaa03d7ba9f5fc9e66f")},
		blockNumber:          4369999,
		transactionIndex:     0,
		nonce:                175,
		timestamp:            0, // 1508131303,
		from:                 cppString{content: []byte("0x53871c23523453988ebd6524fcb0ea29241ca4d2")},
		to:                   cppString{content: []byte("0x8d12a197cb00d4747a1fe03395095ce2a5cc6819")},
		value:                biguint_t[uint64]{len: 0},
		gas:                  250000,
		gasPrice:             50000000000,
		maxFeePerGas:         0,
		maxPriorityFeePerGas: 0,
		input:                cppString{content: []byte("0x338b5dea000000000000000000000000f3db5fa2c66b7af3eb0c0b782510816cbe4813b800000000000000000000000000000000000000000000000000000000004c4b40")},
		hasToken:             0,
		receipt: CReceipt{
			contractAddress:   cppString{content: []byte("0x0")},
			gasUsed:           53673,
			effectiveGasPrice: 50000000000,
			logs: cArray[CLogEntry]{
				items: []CLogEntry{
					CLogEntry{
						address:  cppString{content: []byte("0xf3db5fa2c66b7af3eb0c0b782510816cbe4813b8")},
						logIndex: 0,
						topics: cArray[CTopic]{
							items: []CTopic{
								cppString{content: []byte("0xddf252ad1be2c89b69c2b068fc378daa952ba7f163c4a11628f55a4df523b3ef")},
								cppString{content: []byte("0x00000000000000000000000053871c23523453988ebd6524fcb0ea29241ca4d2")},
								cppString{content: []byte("0x0000000000000000000000008d12a197cb00d4747a1fe03395095ce2a5cc6819")},
							},
						},
						data: cppString{content: []byte("0x00000000000000000000000000000000000000000000000000000000004c4b40")},
					},
					CLogEntry{
						address:  cppString{content: []byte("0x8d12a197cb00d4747a1fe03395095ce2a5cc6819")},
						logIndex: 1,
						topics: cArray[CTopic]{
							items: []CTopic{
								cppString{content: []byte("0xdcbc1c05240f31ff3ad067ef1ee35ce4997762752e3a095284754544f4c709d7")},
							},
						},
						data: cppString{content: []byte("")},
					},
				},
			},
			status: 1,
	...
	helperCheckTransaction(t, &block.transactions.items[8], &LegacyTransaction{
		hash:                 cppString{content: []byte("0x5589ddfd9db108fc6be96c68df9fdcc89a0673fde85fb4089653334bb8c1fc71")},
		blockHash:            cppString{content: []byte("0x51bc754831f33817e755039d90af3b20ea1e21905529ddaa03d7ba9f5fc9e66f")},
		blockNumber:          4369999,
		transactionIndex:     8,
		nonce:                254,
		timestamp:            0, // 1508131303,
		from:                 cppString{content: []byte("0x1366a2ca67594ffd5174d0216d60d9ea8deb511f")},
		to:                   cppString{content: []byte("0xb4a68dfdfb56184930c3a84e9244919823c3a2b4")},
		value:                biguint_t[uint64]{len: 1}, // 921920000000000
		gas:                  21000,
		gasPrice:             20000000000,
		maxFeePerGas:         0,
		maxPriorityFeePerGas: 0,
		input:                cppString{content: []byte("0x")},
		hasToken:             0,
		receipt: CReceipt{
			contractAddress:   cppString{content: []byte("0x0")},
			gasUsed:           21000,
